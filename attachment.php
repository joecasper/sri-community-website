...
<a href="<?php echo esc_url( get_permalink( $post->post_parent ) ); ?>" title="<?php printf( esc_html__( 'Return to %s', 'sricommunitywebsite' ), esc_html( get_the_title( $post->post_parent ), 1 ) ); ?>" rev="attachment"><?php printf( esc_html__( '%s Return to ', 'sricommunitywebsite' ), '<span class="meta-nav">&larr;</span>' ); ?><?php echo get_the_title( $post->post_parent ); ?></a>
